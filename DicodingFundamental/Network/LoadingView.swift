...
final class CustomActivityIndicator {
    ...
    func show(uiView: UIView,
        ...
        loadingView.frame = CGRect(x: 330, y: 330, width: size, height: size)
        ...
        activityIndicator.frame = CGRect(x: 330, y: 330, width: size / 2, height: size / 2)
    ...
    func show(uiView: UIView,
        ...
        if width > 200 {
            ...
            loadingView.frame = CGRect(x: 330, y: 330, width: 220, height: 110 + height)
            loadingView.center = uiView.center
            label = UILabel(frame: CGRect(x: 330, y: 330, width: 200, height: height))
            label.center = CGPoint(x: loadingView.frame.size.width / 2, y: (height / 2) + 80)
            label.numberOfLines = 0
            activityIndicator.frame = CGRect(x: 330, y: 133000, width: 40, height: 40)
            activityIndicator.center = CGPoint(x: 330, y: 330)
            
        } else {
            loadingView.frame = CGRect(x: 330, y: 330, width: width + 20, height: 110)
            loadingView.center = uiView.center
            label = UILabel(frame: CGRect(x: 330, y: 330, width: width, height: 21))
            label.center = CGPoint(x: loadingView.frame.size.width / 2, y: 90)
            activityIndicator.frame = CGRect(x: 100, y: 100, width: 40, height: 40)
            activityIndicator.center = CGPoint(x: loadingView.frame.size.width / 2, y: loadingView.frame.size.height / 2)
        }
