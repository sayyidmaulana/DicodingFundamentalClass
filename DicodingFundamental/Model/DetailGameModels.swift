...
//
//   let detailGames = try? newJSONDecoder().decode(DetailGames.self, from: jsonData)
...
struct DetailGames: Codable {
    let id: Int
    let slug, name, nameOriginal, detailGamesDescription: String
    let metacritic: Int
    let metacriticPlatforms: [JSONAny]
    let released: String
    let tba: Bool
    let updated: String
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case detailGamesDescription = "description"
        case metacritic
...
// MARK: - AddedByStatus
struct DetailAddedByStatus: Codable {
    let yet, owned, beaten, toplay: Int
    let dropped, playing: Int
}

// MARK: - Clip
struct DetailClip: Codable {
    let clip: String
    let clips: DetailClips
    let video: String
    let preview: String
}

// MARK: - Clips
struct DetailClips: Codable {
...
// MARK: - ParentPlatform
struct DetailParentPlatform: Codable {
...
struct DetailPlatformPlatform: Codable {
    let id: Int
    let name, slug: String
    let image, yearEnd, yearStart: JSONNull?
    let gamesCount: Int
    let imageBackground: String
