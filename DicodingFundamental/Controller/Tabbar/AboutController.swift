...
class AboutController: UIViewController {
    ...
    lazy var titleStackView: UIStackView = {
        ...
        subtitleLabel.text = "Self Information"
    ...
    private func setupView() {
        ...
        itemImage.setAnchor(top: view.safeAreaLayoutGuide.topAnchor, left: view.leadingAnchor, bottom: nil, right: view.trailingAnchor, paddingTop: 20, paddingLeft: 35, paddingBottom: 0, paddingRight: 35, width: 0, height: 320)
    ...
    func setLibrary() {
        itemImage.setObject{_ in
            ...
            itemImage.image = #imageLiteral(resourceName: "profile")
        }
        ...
        itemMail.setObject{_ in
            ...
            itemMail.text = "mistermaulan@gmail.com\n\nLet me introduce my self my nickname is Maul i am a researcher who always curious about something new, and my hobbies is travelling. Cheers!"
        }
    }
